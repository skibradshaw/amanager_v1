...
@section('content')
  ...
  <div class="row collapse">
	    ...
	    <div class="large-2 columns left">
			{!! Form::text('paid_date',(isset($payment->paid_date)) ? $payment->paid_date->format('n/j/Y') : \Carbon\Carbon::now()->format('n/j/Y'),['id' => 'datepicker','placeholder' => 'mm/dd/yy', 'style' => 'position: relative; z-index: 100000;']) !!}	      
	    </div>
   </div>
  <div class="row collapse">
	    <div class="large-2 columns">
	    ...
	    <div class="large-4 columns left">
	        {!! Form::select('payment_type',$payment_types, (isset($payment_type)) ? $payment_type : $payment->payment_type) !!}
	    </div>
   </div>
  <div class="row collapse">
	    <div class="large-2 columns">
